...
const ACTION = {
  ...
  // QS approval (enhancement #3)
  SUBMIT_QS:          { label: "Submitted for QS",   cls: "bg-indigo-50 text-indigo-700 ring-indigo-200" },
  QS_APPROVE_SOURCING:{ label: "QS approved",        cls: "bg-emerald-50 text-emerald-700 ring-emerald-200" },
  QS_SEND_BACK:       { label: "QS sent back",       cls: "bg-amber-50 text-amber-700 ring-amber-200" },
  PRICE_UPDATE:       { label: "Price updated",      cls: "bg-sky-50 text-sky-700 ring-sky-200" },
  QS_APPROVE_PRICE:   { label: "QS approved price",  cls: "bg-emerald-50 text-emerald-700 ring-emerald-200" },
  QS_SEND_BACK_PRICE: { label: "QS sent price back", cls: "bg-amber-50 text-amber-700 ring-amber-200" },
  CLOSE:          { label: "PO closed",          cls: "bg-emerald-50 text-emerald-700 ring-emerald-200" },
  PRICE:          { label: "Price updated",      cls: "bg-sky-50 text-sky-700 ring-sky-200" },
